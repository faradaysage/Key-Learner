...
var touchCounter=new CountingRecognizer();
for(var i=1;i<=100;i++) Check(touchCounter.CountNext()==i,"touch count advances once: "+i);
Check(touchCounter.Expected==1 && touchCounter.Pending=="","touch hundred resets cleanly");
Check(touchCounter.CountNext()==1,"touch counting starts the next round");
