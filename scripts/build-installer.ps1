...
Push-Location $root
try {
 dotnet publish KeyLearner.csproj -c Release -r win-x64 --self-contained true -o $publish "-p:Version=$Version" "-p:FileVersion=$Version.0" -p:PublishSingleFile=false
