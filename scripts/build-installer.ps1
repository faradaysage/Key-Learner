...
try {
 ...
 foreach($required in @('KeyLearner.exe','coreclr.dll','Content/Branding/KeyLearner.ico','Content/Voice/a.wav','Content/Fonts/StudioRounded.xnb','Content/Effects/fire-atlas.png','Content/Sounds/fire.wav','Content/Sounds/shatter.wav','Content/Sounds/ATTRIBUTION.md','Content/Sounds/squawk.wav','Content/Shaders/LiquidDensity.xnb','Content/Shaders/LiquidSurface.xnb','Content/Shaders/Glass.xnb','Content/Shaders/Paint.xnb','Content/Shaders/Toon.xnb')){
