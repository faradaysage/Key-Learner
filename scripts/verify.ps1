...
try {
    ...
    foreach ($scenario in @('balloon','balloon-sequence','rapid-milk','guided-mommy','milk','mommy','fire','fire-tap','icons','options','extra-key','counting','picker','game-picker','picker-select','window-resume','dots-visible','dots-correct','dots-retry')) {
