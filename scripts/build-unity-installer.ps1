...
if(Get-ChildItem -LiteralPath $WindowsBuild -Recurse -File | Where-Object {$_.Extension -in @('.py','.pyc','.safetensors','.pt','.pth','.onnx')}){throw 'Development speech source/models must not be packaged.'}
